...
public class Board extends JPanel implements ActionListener {
    ...
    private void showIntroScreen(Graphics2D g2d) {
        ...
        try {
            File myObj = new File("src/game/highScore.txt");
            Scanner myReader = new Scanner(myObj);
            String data = myReader.nextLine();
            String[] data1 = data.split(" ");
            Font small = new Font("Helvetica", Font.BOLD, 14);
            FontMetrics metr = this.getFontMetrics(small);
            g2d.drawString("Current highscore: " + data1[1] + '\n', (SCREEN_SIZE - metr.stringWidth(data1[1])) / 2, SCREEN_SIZE / 2);
            myReader.close();
    ...
    private void death(Graphics2D g2d) {
        ...
        if (pacsLeft == 0) {
            try {
                ...
                Font small = new Font("Helvetica", Font.BOLD, 14);
                FontMetrics metr = this.getFontMetrics(small);
                g2d.drawString("Current highscore: " + data1[1], (SCREEN_SIZE - metr.stringWidth(data1[1])) / 2, SCREEN_SIZE / 2);
                if(score > Integer.parseInt(data1[1])){
                    g2d.setColor(new Color(0, 32, 48));
                    g2d.fillRect(50, SCREEN_SIZE / 2 - 30, SCREEN_SIZE - 100, 50);
                    g2d.setColor(Color.white);
                    g2d.drawRect(50, SCREEN_SIZE / 2 - 30, SCREEN_SIZE - 100, 50);
                    ...
                    try {
                        FileWriter myWriter = new FileWriter("src/game/highScore.txt", false);
                        myWriter.write(name + " " + score + " " + myDate);
                        myWriter.close();
